...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Assignment.Models.ProductType", b =>
                {
                    ...
                    b.Property<string>("ProductTypeImageUrl")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");
            ...
            modelBuilder.Entity("Assignment.Models.ConversionUnit", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Assignment.Models.Material", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Assignment.Models.Inventory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Assignment.Models.ReceivingDetail", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("ReceivingNoteId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Assignment.Models.Warehouse", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Assignment.Models.ReceivingNote", b =>
                {
                    ...
                    b.Property<bool>("IsStockApplied")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Assignment.Models.ConversionUnit", b =>
                {
                    b.HasOne("Assignment.Models.Unit", "FromUnit")
                        .WithMany("Conversions")
                        .HasForeignKey("FromUnitId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Assignment.Models.Unit", "ToUnit")
            ...
            modelBuilder.Entity("Assignment.Models.Inventory", b =>
                {
                    ...
                    b.HasOne("Assignment.Models.Warehouse", "Warehouse")
                        .WithMany()
            ...
            modelBuilder.Entity("Assignment.Models.ReceivingDetail", b =>
                {
                    ...
                    b.HasOne("Assignment.Models.ReceivingNote", "ReceivingNote")
                        .WithMany("Details")
