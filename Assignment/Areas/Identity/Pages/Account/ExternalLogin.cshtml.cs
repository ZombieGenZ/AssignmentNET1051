...
namespace Assignment.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        private ApplicationUser CreateUser()
        {
            ...
            {
                throw new InvalidOperationException($"Không thể tạo thể hiện của '{nameof(ApplicationUser)}'. Hãy đảm bảo lớp không phải dạng trừu tượng và có constructor không tham số, hoặc ghi đè trang đăng nhập ngoài tại /Areas/Identity/Pages/Account/ExternalLogin.cshtml");
            }
        }
